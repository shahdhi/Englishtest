      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100">
            ...
            <p className="text-gray-600 leading-relaxed">
              Grammar & Vocabulary, Listening Comprehension, Reading & Writing Assessment
            </p>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-10 mb-10">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-6 p-6 bg-green-50 rounded-xl border border-green-200">
              <div className="w-12 h-12 bg-green-700 text-white rounded-full flex items-center justify-center font-bold text-lg flex-shrink-0">2</div>
              <div className="flex-1">
                <h3 className="text-xl font-bold text-gray-800 mb-2">Core Listening</h3>
                <p className="text-green-700 font-medium mb-3">15 minutes • 5 questions</p>
                <p className="text-gray-700 leading-relaxed">
                  Listen to authentic workplace dialogue and demonstrate comprehension of key information, 
                  main ideas, and specific details in professional communication contexts.
                </p>
              </div>
            </div>

            <div className="flex items-start gap-6 p-6 bg-purple-50 rounded-xl border border-purple-200">
              <div className="w-12 h-12 bg-purple-700 text-white rounded-full flex items-center justify-center font-bold text-lg flex-shrink-0">3</div>
              <div className="flex-1">
                <h3 className="text-xl font-bold text-gray-800 mb-2">Core Reading & Writing</h3>
                <p className="text-purple-700 font-medium mb-3">25 minutes • 4 questions</p>
                <p className="text-gray-700 leading-relaxed">
                  Analyze contemporary workplace texts, demonstrate reading comprehension, and produce 
                  structured written responses showcasing critical thinking and argumentation skills.
                </p>
              </div>
            </div>
          </div>
